        ...
        <View style={styles(theme).container}>
            ...
            <View style={styles(theme).numbersContainer}>
                <View style={styles(theme).rowContainer}>
                    ...
                    <Text style={[Typography.BODY, { marginLeft: 5, color: theme.darkmode ? Colors.GRAY_LIGHT : Colors.GRAY_DARK }]}>{t("Expenses ")}({payoutPercent}%)</Text>
                </View>
                <View style={styles(theme).rowContainer}>
                    <Icon name="circle" size={15} color={theme.darkmode ? Colors.GRAY_BLUE : Colors.BLUE} />
                    <Text style={[Typography.BODY, { marginLeft: 5, color: theme.darkmode ? Colors.GRAY_BLUE : Colors.BLUE }]}>{t("Income ")}({savedPercent}%)</Text>
                </View>
            </View>
        </View>
    );
